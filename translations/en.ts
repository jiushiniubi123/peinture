export const en = {
  ...
  autoGenerateEnabled: "Auto-generating every 60 seconds",
  autoGenerateDisabled: "Enable auto-generate every 60 seconds",
  autoGenerateOn: "Auto Generate enabled - generating an image every 60 seconds",
