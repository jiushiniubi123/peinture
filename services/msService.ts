...
// Model Scope API base URL. Overridable via VITE_MS_PROXY_URL so the app can
// route calls through a same-origin proxy (server-side) to bypass Model Scope's
// CORS restrictions on its custom X-ModelScope-* headers.
